...
public abstract class AbstractModel implements IModel {
	...
	/**
	 * id used for identification of {@link AbstractModel} 
	...
	private final static Logger logger = Logger.getLogger(AbstractModel.class.getName());

	protected AbstractModel() {
		completelyLoaded = true;
	}
	
	protected AbstractModel(String title, String origin) {
		super();
		this.title = title;
		this.origin = origin;
		completelyLoaded = true;
	...
	protected AbstractModel(String title, String origin, String id) {
		this(title, origin);
		this.importedId = id;
	}
	...
	@Override
	public AbstractModel loadCompleteModel(IPersistenceApi papi) {
		if(!hasDbId()) {
	...
	public void connectRevision(IRevision revision) {
		if(revision != null) {
			((AbstractRevision) revision).setModel(this);
