 ...
 */
package de.uni_potsdam.hpi.bpt.promnicat.utilityUnits.unitData.impl;
...
public class UnitDataJbpt<V extends Object> extends UnitData<V> implements IUnitDataJbpt<V>{
	 ...
	 */
	public UnitDataJbpt(V value, UUID dbId) {
		super(value, dbId);
	}
	 ...
	 */
	public UnitDataJbpt(V value, UUID dbId, ProcessModel model) {
		super(value, dbId);
